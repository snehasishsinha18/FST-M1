...
public class Activity14 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String w4 =driver.findElement(By.xpath("//table[contains(@class, 'table-auto')]/tbody/tr[5]/td[2]")).getText();
		System.out.println(w4);
			
		WebElement w5 =driver.findElement(By.xpath("//table[contains(@class, 'table-auto')]/thead/tr/th[5]"));
		w5.click();
		
		String w6 =driver.findElement(By.xpath("//table[contains(@class, 'table-auto')]/tbody/tr[5]/td[2]")).getText();
